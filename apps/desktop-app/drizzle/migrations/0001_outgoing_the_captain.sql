...
CREATE TABLE `__new_candidate_tallies` (
	`election_id` text,
	`candidate_id` text,
...
INSERT INTO `__new_candidate_tallies`("election_id", "candidate_id", "votes_count", "percentage", "updated_at") SELECT "election_id", "candidate_id", "votes_count", "percentage", "updated_at" FROM `candidate_tallies`;--> statement-breakpoint
DROP TABLE `candidate_tallies`;--> statement-breakpoint
ALTER TABLE `__new_candidate_tallies` RENAME TO `candidate_tallies`;--> statement-breakpoint
...
CREATE TABLE `__new_adminAuth` (
	...
	`access_token` text,
	`refresh_token` text,
	`created_at` text DEFAULT '2025-10-28T12:04:37.685Z',
	`updated_at` text,
	`deleted_at` text,
	`synced_at` text
);
...
CREATE TABLE `__new_candidates` (
	...
	`partylist_id` text,
	`created_at` text DEFAULT '2025-10-28T12:04:37.688Z',
	`updated_at` text,
	`deleted_at` text,
...
CREATE TABLE `__new_elections` (
	...
	`end_time` text,
	`end_date` text,
	`created_at` text DEFAULT '2025-10-28T12:04:37.687Z',
	`updated_at` text,
	`deleted_at` text,
	`synced_at` integer DEFAULT 0
);
...
CREATE TABLE `__new_partylist` (
	...
	`logo` text,
	`logo_path` text,
	`created_at` text DEFAULT '2025-10-28T12:04:37.689Z',
	`updated_at` text,
	`deleted_at` text,
	`synced_at` integer DEFAULT 0
);
