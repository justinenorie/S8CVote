...
CREATE TABLE `__new_adminAuth` (
	...
	`access_token` text,
	`refresh_token` text,
	`created_at` text DEFAULT '2025-10-25T05:30:11.874Z',
	`updated_at` text,
	`deleted_at` text,
	`synced_at` text
);
...
CREATE TABLE `__new_candidates` (
	...
	`profile` text,
	`profile_path` text,
	`created_at` text DEFAULT '2025-10-25T05:30:11.879Z',
	`updated_at` text,
	`deleted_at` text,
...
--> statement-breakpoint
INSERT INTO `__new_candidates`("id", "name", "description", "election_id", "profile", "profile_path", "created_at", "updated_at", "deleted_at", "synced_at") SELECT "id", "name", "description", "election_id", "profile", "profile_path", "created_at", "updated_at", "deleted_at", "synced_at" FROM `candidates`;--> statement-breakpoint
...
CREATE TABLE `__new_elections` (
	...
	`end_time` text,
	`end_date` text,
	`created_at` text DEFAULT '2025-10-25T05:30:11.878Z',
	`updated_at` text,
	`deleted_at` text,
	`synced_at` integer
);
...
CREATE TABLE `__new_students` (
	...
	`created_at` text DEFAULT '2025-10-25T05:30:11.880Z',
	`updated_at` text,
	`deleted_at` text,
	`synced_at` integer DEFAULT 0
);
